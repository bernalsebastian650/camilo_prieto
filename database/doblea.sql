...
-- Tiempo de generación: 08-06-2022 a las 01:14:44
...
(1, 'Futbol', 'Deporte', 'Activo', '2022-04-19 09:30:26', '2022-04-19 09:30:26'),
(2, 'Microfutbol', 'Deporte', 'Activo', '2022-04-19 09:30:48', '2022-04-19 09:30:48'),
(3, 'Futbol8', 'Deporte', 'Activo', '2022-04-19 09:31:12', '2022-04-19 09:31:12'),
(4, 'Futbol Sala', 'Deporte', 'Activo', '2022-04-19 09:31:23', '2022-04-19 09:31:23'),
(5, 'Numero 5', 'Deporte', 'Activo', '2022-04-19 09:31:39', '2022-04-19 09:31:39'),
(6, 'Voleibol', 'Deporte', 'Activo', '2022-04-19 09:31:52', '2022-04-19 09:31:52'),
(7, 'Llavero', 'Articulo', 'Activo', '2022-04-19 09:32:16', '2022-04-19 09:32:16');
...
INSERT INTO `productos` (`id`, `nombre`, `precio`, `porcentaje_ganancia`, `stock`, `categoria_id`, `estado`, `created_at`, `updated_at`) VALUES
(1, 'Futbol', '48000', 20, 6, 1, 'Activo', '2022-04-19 09:33:22', '2022-04-19 09:33:22'),
(2, 'Microfutbol', '30000', 20, 5, 2, 'Activo', '2022-04-19 09:34:20', '2022-04-19 09:34:20'),
(3, 'Futbol8', '35000', 20, 5, 3, 'Activo', '2022-04-19 09:34:43', '2022-04-19 09:34:43'),
(4, 'Futbol Sala', '28000', 20, 5, 4, 'Activo', '2022-04-19 09:35:07', '2022-04-19 09:35:07'),
(5, 'Numero 5', '36000', 20, 5, 5, 'Activo', '2022-04-19 09:35:30', '2022-04-19 09:35:30'),
(6, 'Voleibol', '30000', 20, 5, 6, 'Activo', '2022-04-19 09:35:50', '2022-04-19 09:35:50'),
(7, 'Llavero', '15000', 20, 5, 7, 'Activo', '2022-04-19 09:36:11', '2022-04-19 09:36:11');
...
INSERT INTO `usuarios` (`id`, `nombres`, `apellidos`, `tipo_documento`, `documento`, `telefono`, `direccion`, `municipio_id`, `fecha_nacimiento`, `user`, `password`, `rol`, `estado`, `created_at`, `updated_at`) VALUES
(1, 'Usuario', 'Admin', 'C.C', 12312312, 311324325, 'Transveral 27 15 -35', 15759, '1980-03-03', 'admin', '$2y$10$mu74QzqBhfDI39WAhl.wseeRWBixAHczHHwdBKBGg/TG1ilkXNJ6e', 'Administrador', 'Activo', '2022-04-19 03:37:31', '2022-04-19 04:22:27'),
(2, 'Juan Pablo', 'Garcia Gonzales', 'C.C', 46357159, 3118864151, 'Transveral 27 18-34', 15759, '2000-09-09', NULL, NULL, 'Empleado', 'Activo', '2022-04-19 03:37:31', '2022-06-08 00:41:54');
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuarios_municipios1_idx` (`municipio_id`);
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_usuarios_municipios1` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
